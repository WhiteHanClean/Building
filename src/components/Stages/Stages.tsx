...
const Stages = () => {
  return (
    <div className={s.stages_container}>
      <div className={s.stages_picture_wrapper}>
        <Image
        ...
        />
        <div className={s.info_overlay}>
          <h1 className={s.info_header}>Мы заботимся о вашем комфорте</h1>
          <p className={s.info_description}>
      ...
      <div className={s.stages_cards_wrapper}>
        <StageCard
          number={'1'}
