    ...
    <div className={s.consultation}>
      ...
      <div className={s.consultation_content_form}>
        <form className={s.form_consultation}>
          ...
          <textarea className={s.last_input_consultation} placeholder="Напишите интересующий вас вопрос" />
          ...
          <button className={s.consultation_btn} onClick={(event) => handleClickConsultation(event)}>
            Отправить заявку
          </button>
        </form>
      </div>
